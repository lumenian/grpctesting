...
func (x *AllUsersRequest) GetStart() uint32 {
	if x != nil {
		return x.Start
	}
	return 0
...
func (x *AllUsersRequest) GetEnd() uint32 {
	if x != nil {
		return x.End
	}
	return 0
...
type AllUsersReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	GoTime uint64  `protobuf:"varint,1,opt,name=go_time,json=goTime,proto3" json:"go_time,omitempty"`
	Users  []*User `protobuf:"bytes,2,rep,name=users,proto3" json:"users,omitempty"`
}

func (x *AllUsersReply) Reset() {
	*x = AllUsersReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *AllUsersReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AllUsersReply) ProtoMessage() {}

func (x *AllUsersReply) ProtoReflect() protoreflect.Message {
	mi := &file_proto_users_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AllUsersReply.ProtoReflect.Descriptor instead.
func (*AllUsersReply) Descriptor() ([]byte, []int) {
	return file_proto_users_proto_rawDescGZIP(), []int{1}
}

func (x *AllUsersReply) GetGoTime() uint64 {
	if x != nil {
		return x.GoTime
	}
	return 0
...
func (x *AllUsersReply) GetUsers() []*User {
	if x != nil {
		return x.Users
	}
	return nil
...
var file_proto_users_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x22, 0x39, 0x0a, 0x0f, 0x41, 0x6c,
	...
	0x52, 0x03, 0x65, 0x6e, 0x64, 0x22, 0x4b, 0x0a, 0x0d, 0x41, 0x6c, 0x6c, 0x55, 0x73, 0x65, 0x72,
	0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x17, 0x0a, 0x07, 0x67, 0x6f, 0x5f, 0x74, 0x69, 0x6d,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x67, 0x6f, 0x54, 0x69, 0x6d, 0x65, 0x12,
	...
	0x72, 0x73, 0x22, 0xb0, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x1d, 0x0a, 0x0a, 0x66,
	...
	,
...
var file_proto_users_proto_goTypes = []interface{}{
	(*AllUsersRequest)(nil), // 0: users.AllUsersRequest
	(*AllUsersReply)(nil),   // 1: users.AllUsersReply
	(*User)(nil),            // 2: users.User
}
var file_proto_users_proto_depIdxs = []int32{
	2, // 0: users.AllUsersReply.users:type_name -> users.User
	0, // 1: users.Users.AllUsers:input_type -> users.AllUsersRequest
	1, // 2: users.Users.AllUsers:output_type -> users.AllUsersReply
